...
When working for Posten Bring thsi year, I did an internal presentation called "Tests You Can Trust". The presentation [(online link)](https://docs.google.com/presentation/d/e/2PACX-1vS8frdMD3PNr5yg1l2WNBJRpmQOoHFfan2bzbmrSOEX_mMsIO8Orlk7DeVozYlJDO3Lfe7bD-MqOh3e/pub?start=true&loop=false&delayms=10000) covers a wide range of strategies for building more trustworthy tests, including the use of Fakes and controlling time, with [code examples (in a repo)](https://github.com/fatso83/supporting-code/tree/sjef/trusted-tests) for Java and Javascript.
